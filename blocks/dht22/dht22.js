...
Blockly.Blocks['dht22_config'] = {
    init: function() {
        this.appendDummyInput()
            .appendField("DHT22")
            .appendField(new Blockly.FieldImage("https://www.electronicwings.com/public/images/user_images/images/Sensor%20%26%20Modules/DHT11/1_DHT11_Pins.png", 90, 90, { alt: "*", flipRtl: "FALSE" }));
        this.appendDummyInput()
            .appendField("PINOUT")
