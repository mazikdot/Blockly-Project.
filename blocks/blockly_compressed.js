...
Blockly.Xml.blockToDom_ = function(a) {
    ...
    for (c = 0; d = a.inputList[c]; c++) {
        ...
        d.type != Blockly.DUMMY_INPUT && (g = d.connection.targetBlock(), d.type == Blockly.INPUT_VALUE ? h = goog.dom.createDom("value") : d.type == Blockly.NEXT_STATEMENT && (h = goog.dom.createDom("statement")), e = d.connection.getShadowDom(),
            !e || g && g.isShadow() || h.appendChild(Blockly.Xml.cloneShadow_(e)), g && (h.appendChild(Blockly.Xml.blockToDom_(g)), f = !1), h.setAttribute("name", d.name), f || b.appendChild(h))
    }
...
Blockly.Xml.domToBlockHeadless_ = function(a, b, c) {
    ...
    for (var g = null, f = 0, h; h = b.childNodes[f]; f++)
        if (3 != h.nodeType) {
            for (var k = g = null, l = 0, p; p = h.childNodes[l]; l++) 1 == p.nodeType && ("block" == p.nodeName.toLowerCase() ?
                g = p : "shadow" == p.nodeName.toLowerCase() && (k = p));
            !g && k && (g = k);
    ...
    if (!this.options.readOnly) {
        ...
        if (this.options.collapse) {
            for (var g = f = !1, h = 0; h < e.length; h++)
                for (var k = e[h]; k;) k.isCollapsed() ?
                    f = !0 : g = !0, k = k.getNextBlock();
            var l = function(a) {
        ...
        for (var p = [], h = 0; h < e.length; h++) b(e[h]);
        f = {
            text: 1 >= p.length ? Blockly.Msg.DELETE_BLOCK : Blockly.Msg.DELETE_X_BLOCKS.replace("%1", String(p.length)),
            enabled: 0 < p.length,
            callback: function() {
                (2 >
                    p.length || window.confirm(Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1", String(p.length)))) && c()
            }
        };
        d.push(f);
        ...
        if (!("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
            ...
            if (2 == Blockly.dragMode_) {
                ...
                for (var f = b.getConnections_(!1), h = null, k = null, l = Blockly.SNAP_RADIUS, e = 0; e < f.length; e++) {
                    var p = f[e],
                        m = p.closest(l, g, d);
                    m.connection && (h = m.connection, k = p, l = m.radius)
                }
...
Blockly.Flyout.prototype.show = function(a) {
    ...
    this.reflowWrapper_ = Blockly.bindEvent_(this.workspace_.getCanvas(), "blocklyWorkspaceChange", this,
        this.reflow);
        ...
        for (var g = 0, h; h = a.childNodes[g]; g++)
            if (h.tagName) switch (h.tagName.toUpperCase()) {
                case "CATEGORY":
                    ...
                    "true" == h.getAttribute("expanded") ? (k.blocks.length && c.setSelectedItem(k), k.setExpanded(!0)) : k.setExpanded(!1);
                    break;
                case "SEP":
...
Blockly.parseOptions_ = function(a) {
    ...
    q.length = parseFloat(m.length) || 1;
